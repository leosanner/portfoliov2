...
export function CartoonButton({
  ...
  const base =
    "relative inline-block rounded-full border-2 px-6 py-3 font-label text-sm font-bold overflow-hidden transition-all duration-300 ease-out hover:-translate-y-1 active:translate-y-0 active:shadow-none sm:px-9 sm:py-4 sm:text-base";
